...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'orxfa3-176-214-50-117.ru.tuna.am']
...
#celery -A marketplace_api worker -l info -P eventlet

#celery -A marketplace_api beat -l info

#celery -A marketplace_api flower --port=5555
